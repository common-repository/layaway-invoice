    ...
    $(document).ready(function(){
        $(document).on('change', 'input[name="partial_payment"]', function(e){
            ...
            if (isChecked) {
                ...
                console.log(laya_invc_ajax_object.nonce);
                $.ajax({
       
                    url: laya_invc_ajax_object.ajaxurl,
                    type: 'POST',
                    data: {
                        action: 'laya_invc_set_partialy_payment_on_checked',
                        partially_payment_set: partially_val,
                        wp_chechk_nonce_set_partialy_payment_on_checked:  laya_invc_ajax_object.nonce,
                    },
            ...
            $.ajax({
                    ...
                    data: {
                        ...
                        wp_chechk_nonce_set_partialy_payment_on_un_checked:  laya_invc_ajax_object.nonce,
                    },
                    success: function(results) {
                        //alert(results);
                          $("#partialy_check").val(results);
